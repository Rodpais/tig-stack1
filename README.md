...
[**Telegraf**](https://hub.docker.com/_/telegraf) / `1.34.4`

[**InfluxDB**](https://hub.docker.com/_/influxdb) / `2.7.12`

[**Grafana-OSS**](https://hub.docker.com/r/grafana/grafana-oss) / `12.0.1`
